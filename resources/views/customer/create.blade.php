...
@section('content')
    <div>
        <div
            ...
            <h1 class="h4">Create Customer</h1>
        ...
        <div class="bg-box px-md-4 px-2 py-4 mx-1">
            <form method="post" action="{{secure_url('customer')}}" id="validation_form">
                @csrf
                <div class="row">
...
@endsection
@section('js')
    {!! JsValidator::formRequest('App\Http\Requests\StoreCustomerRequest','#validation_form') !!}
@endsection
